...
class AccountTypeSelectionScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      body: Stack(
        children: [
          // Decorative skyline footer, subtle & theme-aware.
          Positioned(
            left: 0,
            right: 0,
            bottom: 0,
  ...
  void _onSelect(BuildContext context, WidgetRef ref, AccountType type) {
    ...
    ScaffoldMessenger.of(context)
      ...
      ..showSnackBar(
        SnackBar(
          content: Text('Selected: ${type.title}'),
          behavior: SnackBarBehavior.floating,
        ),
      );
    // TODO: navigate to the relevant onboarding flow, e.g.:
    // Navigator.of(context).pushNamed(type == AccountType.personal
    //     ? '/onboarding/personal'
